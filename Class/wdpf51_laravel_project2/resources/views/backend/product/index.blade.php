                ...
                <div class="card-inner p-0">
                    <div class="nk-tb-list">
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col"><span>Product Category</span></div>
                        ...
                        <div class="nk-tb-item">
                            ...
                            <div class="nk-tb-col">
                                <span class="tb-lead">{{$product->product_category}}</span>
                            </div>
            ...
            <form action="{{url('/products')}}" method="POST">
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <textarea class="form-control-wrap" name="product_details" class="form-control" id="product_details" cols="47", rows="2">
                            </textarea>
