                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <ul class="link-list-opt no-bdr">
                                                    ...
                                                    <li><form onsubmit="return confirm('Are you sure you want to delete' )" method="POST" action="{{route('products.destroy',$product->id)}}" class="remove">
                                                        {{method_field('DELETE')}}
                                                        <input type="hidden">
                                                        @csrf
                                                        <em class="icon ni ni-trash"></em>
                                                        <input type="submit" value="remove" > Remove Product </input><span></span></form></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </li>
                ...
                <form name="productForm" action="{{url('/products')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <textarea name="product_details" id="product_details" cols="30" rows="6" class="form-control"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
