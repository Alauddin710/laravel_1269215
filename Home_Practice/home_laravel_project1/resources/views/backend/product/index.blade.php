                        ...
                        <div class="nk-tb-list">
                            ...
                            @foreach ($products as $product)
                                <div class="nk-tb-item">
                                    ...
                                    <div class="nk-tb-col">
                                        {{-- product details leka limit korar jonno aita babohar kora hoice --}}
                                        <span class="tb-lead">{{ Str::limit($product->product_details, 30, '>>>') }}</span>
                                    </div>
                                    <div class="nk-tb-col">
                                                        ...
                                                        <ul class="link-list-opt no-bdr">
                                                            ...
                                                            <li>
                                                                <form method="post"
                                                                    ...
                                                                    <input type="submit" value="Remove">Remove
                                                                    Product</input>
                                                                </form>
                                                            </li>
                                                        </ul>
        ...
        <div class="nk-add-product toggle-slide toggle-slide-right" data-content="addProduct" data-toggle-screen="any"
            ...
            <div class="nk-block">
                <div class="row g-3">
                    ...
                    @endif
                    {{-- end error sho code --}}
                    <form name="productForm" action="{{ url('products') }}" method="POST"
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <textarea name="pr_details" id="pr_details" cols="30" rows="6" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <label class="form-label" for="pr_price">Product Price</label>
                                <div class="form-control-wrap">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label class="form-label" for="pr_category">Product Category</label>
                                <div class="form-control-wrap">
                                    <select name="pr_category" class="form-control" id="pr_category">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label class="form-label" for="pr_stock">Product Stock</label>
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" name="pr_stock" id="pr_stock">
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" name="pr_image" id="pr_image">
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <button type="submit" id="addnew" class="btn btn-primary"><em
